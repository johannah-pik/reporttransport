...
R package **reporttransport**, version **0.9.0**
...
Hoppe J, Muessel J, Hagen A (2025). "reporttransport: Reporting package for edgeTransport." Version: 0.9.0, <https://github.com/pik-piam/reporttransport>.
